...
public class ToolActivity extends AbsSubActivity {
	...
	private String[] title = {"会员注册", "会员充值", "会员改密", "结算", "关于我们"};
	private int[] icons= {R.drawable.icon_tool_0,R.drawable.icon_tool_1,R.drawable.icon_tool_2,R.drawable.icon_tool_3,R.drawable.icon_tool_4};
	@Override
